...
public interface OdeMessages extends Messages, AutogeneratedOdeMessages {
  ...
  @DefaultMessage("Please select a project to open project property dialog")
  @Description("Error message displayed when no project is selected")
  String noProjectSelected();


  @DefaultMessage("Please select only one project to open project property dialog")
  @Description("Error message displayed when more than one project selected")
  String moreThanOneProjectSelected();
